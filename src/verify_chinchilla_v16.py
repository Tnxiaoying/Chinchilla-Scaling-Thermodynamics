...
# --- v16: 完美调校版 (Precision Tuned) ---
# 目标：让 N=2 的 Loss 劣化到 0.6 以上，从而显现左侧下降坡。
# 参数：
# Map = 80x80 (6400格)
# C = 4e4 (4万) -> N=2 时 D=3333 (仅能覆盖约 40-50%)

@dataclass
class Config:
    grid_size: int = 80          # 地图适中
    total_compute: float = 4e4   # 【精准刀法】预算削减至 4万
...
def run_iso_compute_sweep():
    ...
    print(f"Starting Precision Tuned Sweep (N=2..150)...")
